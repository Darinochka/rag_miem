...
STUDY_CLASSIFIER_HOST - адрес классификатора, определяющий относится ли запрос к контактной базе или к основной. На данный момент используется обученный bert. Например, http://192.168.0.1:11434/api/classify
...
# Классификатор (STUDY_CLASSIFIER_HOST)
